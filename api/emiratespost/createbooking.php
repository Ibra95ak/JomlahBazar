...
$res_cities = $client->request('GET', 'https://osbtest.epg.gov.ae/ebs/genericapi/lookups/rest/GetEmiratesDetails');
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://osbtest.epg.gov.ae/ebs/genericapi/booking/rest/CreateBooking',
