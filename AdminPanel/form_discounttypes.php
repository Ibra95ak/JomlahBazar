...
<div class="kt-portlet">
    ...
    <form class="kt-form kt-form--label-right" id="jbform">
        ...
        <div class="form-group row">
                <div class="col-lg-4">
                    <label>discounttypeId:</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i
                                    class="la la-user"></i></span></div>
                        <input discounttypeId="text" disabled class="form-control" placeholder="" name="discounttypeId" id="discounttypeId"
                            value="<?php if(isset($discounttypeId)) echo $discounttypeId;else echo '';?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                case 0:
                    ...
                    setTimeout(function() {
                        ...
                        window.location.replace(
                            "localhost/JomlahBazar/AdminPanel/por_discounttypes.php"
                        );
                    }, 2000);
                    break;
                case 1:
