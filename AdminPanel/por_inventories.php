...
if($checklogin){
include('header.php');
require(DIR_ROOT.DIR_ADMINP.DIR_CON.'CON_Inventories.php');?>
<!-- begin:: Content -->
...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-inventories.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_inventories.php?inventoryId=0";?>";
});
</script>
</body>
<!-- end::Body -->
