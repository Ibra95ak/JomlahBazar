        ...
        <div class="kt-portlet__body">
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" disabled class="form-control" placeholder="" name="userId" id="userId" value="<?php if(isset($userId)) echo $userId;else echo '';?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-user"></i></span></div>
                        <input type="text" class="form-control" placeholder="" name="first_name" id="first_name" value="<?php if(isset($first_name)) echo $first_name;else echo '';?>">
                    </div>
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-user"></i></span></div>
                        <input type="text" class="form-control" placeholder="" name="last_name" id="last_name" value="<?php if(isset($last_name)) echo $last_name;else echo '';?>">
                    </div>
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-user"></i></span></div>
                        <input type="text" class="form-control" placeholder="" name="walletId" id="walletId" value="<?php if(isset($walletId)) echo $walletId;else echo '';?>">
                    </div>
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-user"></i></span></div>
                        <input type="text" class="form-control" placeholder="" name="identityId" id="identityId" value="<?php if(isset($identityId)) echo $identityId;else echo '';?>">
                    </div>
