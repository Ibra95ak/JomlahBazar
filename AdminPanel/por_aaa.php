...
if($checklogin){
include('header.php');
require(DIR_ROOT.DIR_ADMINP.DIR_CON.'CON_AAA.php');?>
<!-- begin:: Content -->
...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-aaa.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_aaa.php?aaaId=0";?>";
});
</script>
</body>
<!-- end::Body -->
