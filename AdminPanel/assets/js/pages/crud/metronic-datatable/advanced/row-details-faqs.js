    ...
    var datatable = $(".kt-datatable").KTDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url:
              "http://localhost/JomlahBazar/AdminPanel/controllers/json/Read.php?jsonname=faqs.json",
          },
        },
        pageSize: 10,
        saveState: false,
      ...
      columns: [
        ...
        },
        {
          ...
          template: function (row) {
            return (
              '\
              <a href="http://localhost/JomlahBazar/AdminPanel/form_faqs.php?faqId=' +
              row.faqId +
              '" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
								<i class="la la-edit"></i>\
							</a>\
							<a href="http://localhost/JomlahBazar/AdminPanel/controllers/delete/delete_Faq.php?faqId=' +
              row.faqId +
