    ...
    var datatable = $(".kt-datatable").KTDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url:
              "localhost/JomlahBazar/AdminPanel/controllers/json/Read.php?jsonname=inventories.json",
          },
        },
        pageSize: 10,
        saveState: false,
      ...
      columns: [
        ...
        },
        {
          ...
          template: function (row) {
            return (
              '\
							<a href="localhost/JomlahBazar/AdminPanel/form_inventories.php?inventoryId=' +
              row.inventoryId +
              '" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
								<i class="la la-edit"></i>\
							</a>\
							<a href="localhost/JomlahBazar/AdminPanel/controllers/delete/delete_Inventory.php?inventoryId=' +
              row.inventoryId +
