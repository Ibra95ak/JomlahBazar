...
require(DIR_ROOT.DIR_ADMINP.DIR_CON.'CON_Adminpriviledges.php?adminId='.$adminId);?>
<!-- begin:: Content -->
...
$('#add').click(function(e) {
    window.location="<?php echo DIR_ROOT.DIR_ADMINP."form_adminpriviledges.php?adminpriviledgeId=0";?>";
});
</script>
</body>
<!-- end::Body -->
