...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-priviledges.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_priviledges.php?priviledgeId=0";?>";
});
</script>
</body>
<!-- end::Body -->
