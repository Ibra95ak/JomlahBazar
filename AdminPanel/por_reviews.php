...
if($checklogin){
include('header.php');
require(DIR_ROOT.DIR_ADMINP.DIR_CON.'CON_Reviews.php');
...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-reviews.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_reviews.php?reviewId=0";?>";
});
</script>
</body>
<!-- end::Body -->
