...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-brands.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_brands.php?brandId=0";?>";
});
</script>
</body>
<!-- end::Body -->
