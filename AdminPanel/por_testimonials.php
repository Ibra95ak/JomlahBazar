...
if($checklogin){
include('header.php');
require(DIR_ROOT.DIR_ADMINP.DIR_CON.'CON_Testimonials.php');?>
<!-- begin:: Content -->
...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-testimonials.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_testimonials.php?testimonialId=0";?>";
});
</script>
</body>
<!-- end::Body -->
