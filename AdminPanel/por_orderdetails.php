...
<script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-orderdetails.js" type="text/javascript">
</script>
<script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_orderdetails.php?orderdetailId=0";?>";
});
</script>
</body>
<!-- end::Body -->
