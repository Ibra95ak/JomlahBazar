...
if($checklogin){
include('header.php');
require(DIR_ROOT.DIR_ADMINP.DIR_CON.'CON_Categories.php');?>
<!-- begin:: Content -->
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <script src="assets/js/pages/crud/metronic-datatable/advanced/row-details-categories.js" type="text/javascript">
    </script>
    <script>
$('#add').click(function(e) {
    window.location = "<?php echo DIR_ROOT.DIR_ADMINP."form_categories.php?categoryId=0";?>";
});
</script>
</body>
<!-- end::Body -->
