        ...
        <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" disabled class="form-control" placeholder="" name="subscriptionplanId" id="subscriptionplanId"
                ...
                case 0:
                    ...
                    setTimeout(function() {
                        ...
                        window.location.replace(
                            "localhost/JomlahBazar/AdminPanel/por_subscriptionplans.php"
                        );
                    }, 2000);
                    break;
                case 1:
