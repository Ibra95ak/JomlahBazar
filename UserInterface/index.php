        ...
        <div class="row" style="flex: auto; height: 100%; align-items: center;">
          ...
          <div class="col-lg-4">
            <div class="row flex-nowrap justify-content-around">
              <a
                href="#"
                class="language-toggle nav-a nav-a-2 nav-tool dropdown-toggle d-flex justify-content-center"
              ...
              <div class="language-dropdown dropdown dropdown-menu animate slideIn">
                ...
                <a class="dropdown-item dropdown-text" href="#"
                  >العربية - AR</a
                >
              </div>
              </a>
              <a
                class="login-register-toggle nav-a nav-a-2 nav-tool dropdown-toggle"
              >
                ...
                ></span>
                <div class="dropdown login-register-dropdown dropdown-menu animate slideIn">
                  <a
                    class="dropdown-item dropdown-text"
                    href="/JomlahBazar/UserInterface/login.php"
                    >Login</a
                  >
                  <a class="dropdown-item dropdown-text" href="my-account.html">My Account</a>
                  <a class="dropdown-item dropdown-text" href="register.html">Register</a>
                  <a class="dropdown-item dropdown-text" href="forgot-password.html"
                    >Forgot Password</a
                  >
                </div>
              </a>
...
<!-- hero slider -->
<section class="hero-section overlay bg-cover position-relative home-2">
>>>>>>> 33ef83b25881a58b9625c8121c79b1b79911f2f8
