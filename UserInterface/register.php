                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="aaa_email" id="aaa_email" type="email" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Password<small>Required</small></label>
                                <input name="aaa_password" id="aaa_password" type="password" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Confirm Password<small>Required</small></label>
                                <input name="aaa_cpassword" id="aaa_cpassword" type="password" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-12">
...
-->
    ...
    <script>
        $('#btn_submit').click(function(e) {
            ...
            var err = 0;
            e.preventDefault();
            var email = document.getElementById('aaa_email').value;
            var password = document.getElementById('aaa_password').value;
            var cpassword = document.getElementById('aaa_cpassword').value;
            /*Check if inputs are empty*/
            if (isEmpty('Email', email) || isEmpty('Password', password) || isEmpty('Confirm Password', cpassword)) err = 1;
            /*Validate email format*/
            if (!validateEmail('Email', email)) err = 1;
            if (!isDuplicate(password, cpassword)) err = 1;
            if (err == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://localhost/JomlahBazar/AdminPanel/controllers/CON_Register_AAA.php",
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: formdata,
                            ...
                            case 0:
                                ...
                                setTimeout(function() {
                                    ...
                                    window.location.replace(
                                        "http://localhost/JomlahBazar/UserInterface/index.php?reg=true"
                                    );
                                }, 2000);
                                break;
                            case 1:
