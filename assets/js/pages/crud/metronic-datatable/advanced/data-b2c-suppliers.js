...
$('#filter_ranking').on('change', function() {
	searchGrid();
});
...
$('#min_discount').on('change', function() {
	searchGrid();
});
$('#max_discount').on('change', function() {
	searchGrid();
});
...
$('#loc1, #loc2, #loc3, #loc4, #loc5, #loc6, #loc7').on('change', function() {
	searchGrid();
});
...
var searchGrid = function() {
  ...
  // var selected_mindis = $('#min_discount').val().toLowerCase();
	...
	var url = DIR_CONT+DIR_USR+"CON_Suppliers.php?action=get";
	...
	//  if ($('#loc1').is(':checked')) url+="&loc1=1";
	//  if ($('#loc2').is(':checked')) url+="&loc2=1";
	//  if ($('#loc3').is(':checked')) url+="&loc3=1";
	//  if ($('#loc4').is(':checked')) url+="&loc4=1";
	//  if ($('#loc5').is(':checked')) url+="&loc5=1";
	//  if ($('#loc6').is(':checked')) url+="&loc6=1";
	//  if ($('#loc7').is(':checked')) url+="&loc7=1";
