	...
	var demo = function() {
		...
		var datatable = $('.kt-datatable').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						url: DIR_JSON+'Read.php?jsonname=checkout.json',
					},
				},
        ...
        // }, {
	      ...
	      //                       </a>\
				...
				// 			    </div>\
				// 			</div>\
				// 			<a href="form_users.php?userId='+row.brandId+'" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
