  ...
  var initDemos = function() {
    ...
    $('#phoneSignin').click(function(e) {
      swal.fire({
        ...
        $.post(DIR_CONT+"CON_user_otp.php?action=login", {
            phone: result.value
          },
          function(data, status) {
            ...
            if (status == 'success') {
              swal.fire({
                title: 'Add the code sent to you phone',
                html: $('<div>')
                  .addClass('some-class')
                  .text('Login'),
                ...
                $.post(DIR_CONT+"CON_user_otp.php?action=verify", {
                    token: result.value,
                    phone:otp
                  },
                  function(data, status) {

                    if(data=='verified') location.href=DIR_ROOT+"dashboard.php";
                  });
              })
            }
