...
$cart = new Cart();
	...
	$is_seller = $usr->is_seller;
	$res_ordercount = $client->request('GET', DIR_CONT.DIR_ORD . 'CON_Orders.php?action=get-uncompleted-orders&supplierId='.$userId);
	$ordercount = json_decode($res_ordercount->getBody());
	$orders_count = $ordercount->orders_count;
	if ($orders_count==0) $ordernotice = '';
	else $ordernotice = '<span class="kt-badge kt-badge--warning">'.$orders_count.'</span>';
	$res_quotationcount = $client->request('GET', DIR_CONT.DIR_ORD . 'CON_Orders.php?action=get-uncompleted-quotations&supplierId='.$userId);
	$quotationcount = json_decode($res_quotationcount->getBody());
	$quotations_count = $quotationcount->quotations_count;
	if ($quotations_count==0) $quotationnotice = '';
	else $quotationnotice = '<span class="kt-badge kt-badge--warning">'.$quotations_count.'</span>';
...
$res_company = $client->request('GET', DIR_CONT.DIR_USR.'CON_seller_profile.php?action=get&userId='.$userId);/*fetch all categories*/
$company=json_decode($res_company->getBody());
if ($company->company!='') {
	$username=$company->company[0]->companyname;
...
if($cart->count()!=0){
	...
	foreach ($carts as $i => $item) {
	  $response[$i]['product_id'] = $item->id;
	  $response[$i]['seller_id'] = $item->seller_id;
	  $response[$i]['user_id'] = $userId;
	  $response[$i]['product_name'] = $item->name;
	  $response[$i]['product_price'] = $item->price;
	  $response[$i]['product_quantity'] = $item->quantity;
	  $response[$i]['product_weight'] = $item->weight;
	  if ($db->isExist_Cart($userId, $item->id)) {
	    $db->updateCart($userId, $item->id, $cart->get($item->id)->quantity);
	  } else {
	    $db->addCart($userId, $item->id, $item->seller_id, $item->name, $item->price, $item->quantity, $item->weight, 1);
	  }
	}
	$cart->clear();
}
$res_cartcount = $client->request('GET', DIR_CONT . DIR_CAR . 'CON_carts.php?action=get-supplier-cartcount&userId=' . $userId);/*fetch userId*/
$cartcount = json_decode($res_cartcount->getBody());
?>
<!DOCTYPE html>
<html lang="en">
<!-- begin::Head -->
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
		<div class="kt-header-mobile__logo">
			<a href="javascript:void(0)" class="kt-menu__link hamburger_menu kt-mr-5" data-toggle="modal" data-target="#kt_modal_hamburger"><i class="fa fa-bars" style="font-size: 20px;"></i><span class="kt-font-md kt-ml-5">All</span></a>
		...
		<div class="kt-header-mobile__toolbar">
			<?php
				if ($is_buyer=1 && $is_seller==1) {
					echo '<div class="form-group kt-pt35" data-toggle="kt-tooltip" data-placement="bottom" title="" data-original-title="Switch To">
						<input data-on-text="Buyer" data-off-text="Seller" data-on-color="brand" data-off-color="warning" data-switch="true" data-size="small" type="checkbox" id="usertype_mobile" name="usertype_mobile">
					</div>';
				}
			?>
			<a href="javascript:void(0)" class="kt-menu__link hamburger_menu kt-mr-10 kt-ml-10"><i class="fa fa-user" style="font-size: 20px;" data-toggle="modal" data-target="#kt_modal_user"></i></a>
			<a href="<?php echo DIR_VIEW . 'carts/' . "cart.php" ?>" class="kt-menu__link kt-transparent"><span id="cart-count"><?php echo $cartcount ?></span><img src="<?php echo DIR_ROOT.DIR_ICON?>cart-black.webp" class="cart-icon kt-mt-5"></a>
		</div>
	</div>
	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
		<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper kt-pl0" id="kt_wrapper" style="padding-top: 35px;">
				...
				<!-- begin:: Header -->
				<div id="kt_header" class="kt-header kt-header-b2c kt-grid__item kt-header--fixed left0 diplay-block">
					<!-- begin: Header Menu -->
					<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
							...
							<ul class="kt-menu__nav">
								<li class="kt-menu__item header-slot kt-transparent">
									<?php
										if ($is_buyer=1 && $is_seller==1) {
											echo '<div class="form-group kt-pt35" data-toggle="kt-tooltip" data-placement="bottom" title="" data-original-title="Switch To">
												<input data-on-text="Buyer" data-off-text="Seller" data-on-color="brand" data-off-color="warning" data-switch="true" data-size="small" type="checkbox" id="usertype" name="usertype">
											</div>';
										}
									?>
								</li>
								<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel kt-menu__item--active kt-menu__item--open-dropdown header-slot" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle kt-transparent"><span class="kt-menu__link-text kt-topheader-toptext">Hello, <?php echo $companyname;?></span><span class="kt-menu__link-text kt-topheader-bottomtext">Account & Lists <i class="fa fa-caret-down"></i></span></a>
									<div class="kt-menu__submenu  kt-menu__submenu--fixed kt-menu__submenu--center" style="width:380px">
										<div class="kt-menu__subnav">
											<ul class="kt-menu__content">
												<li class="kt-menu__item ">
													<img src="<?php echo DIR_ROOT.DIR_ICON.'supplier.png'?>" style="width:100px;height:100px;" class="kt-ml-40"/>
													...
													<ul class="kt-menu__inner">
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_ORD . "b2c-received-orders.php?from=".date('Y-m-d',strtotime("-3 month")).'&to='.date('Y-m-d') ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Orders</span><?php echo $ordernotice;?></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_ORD . "received-quotations.php?from=".date('Y-m-d',strtotime("-3 month")).'&to='.date('Y-m-d') ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Received Quotations</span><?php echo $quotationnotice;?></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "dt_sellerstatments.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Accounting</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_PRO . "dt_products.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Jomlah Bazar Inventory</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW.DIR_PRO.'bulkupload.php';?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Bulk Upload</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_PRO . "dt_myproducts.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My Inventory</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_PRO . "form_product.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Add Product</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW.DIR_USR."dt_suppliercarts.php"?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Customer carts</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW.DIR_USR."dt_supplierwishlists.php"?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Customer wishlists</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW.DIR_USR."dt_users.php"?>" class="kt-menu__link "></i><span class="kt-menu__link-text kt-font-warning">Access to Business World</span></a></li>
													</ul>
												</li>
												<li class="kt-menu__item ">
													<ul class="kt-menu__inner">
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_STR . "storedetails.php?userId=".$userId ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My Store</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "form_userlicense.php";?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My License</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_ORD . "my-payments.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My Payments</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "form_userstore.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Company Account</span></a></li>
														...
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "login.php?logout=true" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Sign Out</span></a></li>
													</ul>
												</li>
											</ul>
										</div>
								...
								<li class="kt-menu__item header-slot kt-transparent"><a href="<?php echo DIR_VIEW . DIR_ORD . "b2c-received-orders.php?from=".date('Y-m-d',strtotime("-3 month")).'&to='.date('Y-m-d') ?>" class="kt-menu__link kt-transparent"><span class="kt-menu__link-text kt-topheader-toptext">Returns</span><span class="kt-menu__link-text kt-topheader-bottomtext">& Orders </span><?php echo $ordernotice;?></a></li>
								<li class="kt-menu__item  header-slot"><a href="<?php echo DIR_VIEW.DIR_USR."dt_suppliercarts.php"?>" class="kt-menu__link kt-transparent"><span id="cart-count"><?php echo $cartcount ?></span><img src="<?php echo DIR_ROOT.DIR_ICON?>cart-black.webp" class="cart-icon"/><span id="cart-lable">cart</span></a></li>
							</ul>
						</div>
					</div>
					<!-- end: Header Menu -->
						...
						<div class="modal-dialog modal_hamburger" role="document">
							<div class="modal-content">
								<div class="modal-header bg-dark">
									...
									<h5 class="modal-title kt-font-light" id="exampleModalLabel"> Hello, <?php echo $companyname;?></h5>
								...
								<div class="modal-body full-height">
									...
									<br>
									<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_user.php" ?>" class="kt-link kt-font-transform-u">Your Account</a></p>
									<p><a href="<?php echo DIR_VIEW . DIR_CON . "supportcenter.php" ?>" class="kt-link kt-font-transform-u kt-font-dark">Help</a></p>
									<p><a href="<?php echo DIR_VIEW . DIR_USR . "login.php?logout=true" ?>" class="kt-link kt-font-transform-u kt-font-dark"  >Sign Out</a></p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal fade" id="kt_modal_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal_hamburger" role="document">
							<div class="modal-content">
								...
								<div class="modal-body full-height">
									<h3 class="kt-menu__heading kt-menu__toggle"><span class="kt-menu__link-text kt-font-bolder /*kt-font-light*/">My Business Account</span><i class="kt-menu__ver-arrow la la-angle-right"></i></h3>
										<p><a href="<?php echo DIR_VIEW . DIR_ORD . "b2c-received-orders.php?from=".date('Y-m-d',strtotime("-3 month")).'&to='.date('Y-m-d') ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Orders</span><?php echo $ordernotice;?></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_ORD . "received-quotations.php?from=".date('Y-m-d',strtotime("-3 month")).'&to='.date('Y-m-d') ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Received Quotations</span><?php echo $quotationnotice;?></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_USR . "dt_sellerstatments.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Accounting</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_PRO . "dt_products.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Jomlah Bazar Inventory</span></a></p>
										<p><a href="<?php echo DIR_VIEW.DIR_PRO.'bulkupload.php';?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Bulk Upload</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_PRO . "dt_myproducts.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My Inventory</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_PRO . "form_product.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Add Product</span></a></p>
										<p><a href="<?php echo DIR_VIEW.DIR_USR."dt_suppliercarts.php"?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Customer carts</span></a></p>
										<p><a href="<?php echo DIR_VIEW.DIR_USR."dt_supplierwishlists.php"?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Customer wishlists</span></a></p>
										<p><a href="<?php echo DIR_VIEW.DIR_USR."dt_users.php"?>" class="kt-menu__link "></i><span class="kt-menu__link-text kt-font-warning">Access to Business World</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_STR . "storedetails.php?userId=".$userId ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My Store</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_userlicense.php";?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My License</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_ORD . "my-payments.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">My Payments</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_userstore.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Company Account</span></a></p>
										<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_useraddress.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Addresses</span></a></p>
