...
$res_cartcount = $client->request('GET', DIR_CONT . DIR_CAR . 'CON_carts.php?action=get-cartcount&userId=' . $userId);/*fetch userId*/
...
<!-- End Google Tag Manager (noscript) -->
			...
			<?php
				if ($is_buyer=1 && $is_seller==1) {
					echo '<div class="form-group kt-pt35" data-toggle="kt-tooltip" data-placement="bottom" title="" data-original-title="Switch To">
						<input data-on-text="Buyer" data-off-text="Seller" data-on-color="brand" data-off-color="warning" data-switch="true" data-size="small" type="checkbox" id="usertype_mobile" name="usertype_mobile" checked="checked">
					</div>';
				}
				if ($is_seller==2) {
					echo '<button id="btn-regsel_mobile" type="button" class="btn btn-outline-warning btn-elevate btn-square">Register As Seller</button>';
				}
			?>
	...
	<div class="typeahead">
		<input type="text" class="form-control height-40 header-search-width" aria-label="Text input with dropdown button" id="header_search_text-mobile" placeholder="">
	</div>
							...
							<ul class="kt-menu__nav">
								<li class="kt-menu__item header-slot kt-transparent">
									<?php
										if ($is_buyer=1 && $is_seller==1) {
											echo '<div class="form-group kt-pt35" data-toggle="kt-tooltip" data-placement="bottom" title="" data-original-title="Switch To">
												<input data-on-text="Buyer" data-off-text="Seller" data-on-color="brand" data-off-color="warning" data-switch="true" data-size="small" type="checkbox" id="usertype" name="usertype" checked="checked">
											</div>';
										}
										if ($is_seller==2) {
											echo '<button id="btn-regsel" type="button" class="btn btn-outline-warning btn-elevate btn-square">Register As Seller</button>';
										}
									?>
								</li>
											...
											<ul class="kt-menu__content">
												<li class="kt-menu__item ">
													...
													<ul class="kt-menu__inner">
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "form_user.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Personal Account</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "form_userwallets.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Wallet</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_ORD . "b2c-my-orders.php?from=" . date('Y-m-d',strtotime("-3 month")) . '&to=' . date('Y-m-d') ?>" class="kt-menu__link "><span class="kt-menu__link-text">Orders</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_ORD . "my-quotations.php?from=" . date('Y-m-d',strtotime("-3 month")) . '&to=' . date('Y-m-d') ?>" class="kt-menu__link "><span class="kt-menu__link-text">Quotations</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "form_useraddress.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Addresses</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_CAR . "wishlist.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Wishlists</span></a></li>
														<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo DIR_VIEW . DIR_USR . "login.php?logout=true" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Sign Out</span></a></li>
														<img src="<?php echo DIR_ROOT  . DIR_ICON . 'buyer.webp' ?>" style="width:100px;height:100px;" />
													</ul>
												</li>
											</ul>
										</div>
								...
								<li class="kt-menu__item header-slot kt-transparent"><a href="<?php echo DIR_VIEW . DIR_ORD . "b2c-my-orders.php?from=" . date('Y-m-d',strtotime("-3 month")) . '&to=' . date('Y-m-d') ?>" class="kt-menu__link kt-transparent"><span class="kt-menu__link-text kt-topheader-toptext">Returns</span><span class="kt-menu__link-text kt-topheader-bottomtext">& Orders </span></a></li>
								<li class="kt-menu__item  header-slot"><a href="<?php echo DIR_VIEW . DIR_CAR . "cart.php" ?>" class="kt-menu__link kt-transparent"><span id="cart-count"><?php echo $cartcount; ?></span><img src="<?php echo DIR_ROOT.DIR_ICON?>cart-black.webp" class="cart-icon" /><span id="cart-lable">cart</span></a></li>
							</ul>
						</div>
					</div>
					<!-- end: Header Menu -->
									...
									foreach ($main_categories as $mcategory) {
										if ($mcategory->maincategoryId!=2) {
											...
											foreach ($mcategories->categories as $mcat) {
												if ($mcat->count_pro!=0) {
													echo '<p><a href="'.DIR_VIEW.DIR_PRO.'marketplace.php?cat=' . $mcat->categoryId . '" class="kt-link kt-font-transform-u kt-font-dark">' . $mcat->name . '</a></p>';
												}
											}
											echo '</div>';
										}else {
											...
											foreach ($mcategories->categories as $mcat) {
												...
												echo '<p><a href="'.DIR_VIEW.DIR_PRO.'marketplace.php?'.$feature_name.'=' . $feature_value. '" class="kt-link kt-font-transform-u kt-font-dark">' . $mcat->name . '</a></p>';
											}
											echo '</div>';
										}
									}
					...
					<div class="modal fade" id="kt_modal_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal_hamburger" role="document">
							<div class="modal-content">
								...
								<div class="modal-body full-height">
										<h3 class="kt-menu__heading kt-menu__toggle"><span class="kt-menu__link-text kt-font-bolder /*kt-font-light*/">My Account</span></h3>
											<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_user.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Personal Account</span></a></p>
											<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_userwallets.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Wallet</span></a></p>
											<p><a href="<?php echo DIR_VIEW . DIR_ORD . "b2c-my-orders.php?from=" . date('Y-m-d',strtotime("-3 month")) . '&to=' . date('Y-m-d') ?>" class="kt-menu__link "><span class="kt-menu__link-text">Orders</span></a></p>
											<p><a href="<?php echo DIR_VIEW . DIR_ORD . "my-quotations.php?from=" . date('Y-m-d',strtotime("-3 month")) . '&to=' . date('Y-m-d') ?>" class="kt-menu__link "><span class="kt-menu__link-text">Quotations</span></a></p>
											<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_useraddress.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Addresses</span></a></p>
											<p><a href="<?php echo DIR_VIEW . DIR_CAR . "wishlist.php" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Wishlists</span></a></p>
											<p><a href="<?php echo DIR_VIEW . DIR_USR . "login.php?logout=true" ?>" class="kt-menu__link "><span class="kt-menu__link-text">Sign Out</span></a></p>
