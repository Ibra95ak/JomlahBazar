	...
	<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
		...
		<div class="kt-header-mobile__toolbar">
			<?php
				...
				if ($is_seller==2) {
					echo '<button id="btn-regsel_mobile" type="button" class="btn btn-outline-warning btn-elevate btn-square">Become A Seller</button>';
				}
			?>
							...
							<ul class="kt-menu__nav ">
								<li class="kt-menu__item header-slot kt-transparent">
									<?php
										...
										if ($is_seller==2) {
											echo '<button id="btn-regsel" type="button" class="btn btn-outline-warning btn-elevate btn-square">Become A Seller</button>';
										}
									?>
								</li>
						...
						<div class="modal-dialog modal_hamburger" role="document">
							<div class="modal-content">
								...
								<div class="modal-body full-height">
									...
									<br>
									<p><a href="<?php echo DIR_VIEW . DIR_USR . "form_user.php" ?>" class="kt-link kt-font-transform-u kt-font-dark">Your Account</a></p>
