...
<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop safari-row-desktop-block" id="kt_footer">
  <div class="kt-container  kt-container--fluid ">
      ...
      <div class="col-md-2">
        ...
        <p><a href="<?php  echo DIR_VIEW . DIR_USR . "form_user.php";?>" class="kt-link text-muted">Your Account</a></p>
        <p><a href="<?php  echo DIR_VIEW . DIR_ORD . "b2c-my-orders.php";?>" class="kt-link text-muted">Your Orders</a></p>
        <p><a href="<?php  echo DIR_VIEW . DIR_USR . "form_useraddress.php";?>" class="kt-link text-muted">Your Addresses</a></p>
        <p><a href="<?php  echo DIR_VIEW . DIR_CAR . "wishlist.php";?>" class="kt-link text-muted">Your Wishlists</a></p>
      </div>
      <div class="col-md-2">
