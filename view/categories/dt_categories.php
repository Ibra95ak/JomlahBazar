                  ...
                  <div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
                    <div class="row align-items-center">
                      ...
                      <div class="col-xl-4 order-1 order-xl-2 kt-align-right">
                        <a id="btn-adduser" href="<?php  echo DIR_VIEW.DIR_CAT.'form_category.php?categoryId=0';?>" class="btn btn-default">
...
?>
<script src="assets/js/pages/crud/metronic-datatable/advanced/data-categories.js" type="text/javascript"></script>
