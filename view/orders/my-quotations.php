...
$res_quotations = $client->request('GET', DIR_CONT . DIR_CAR . "CON_functions.php?action=get_quotations&userId=" . $userId . '&from=' . $_GET['from'] . '&to=' . $_GET['to']);
                    ...
                    <div class="kt-portlet kt-portlet--tabs">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                ...
                                <h3 class="kt-portlet__head-title">My Quotations</h3>
                            </div>
                            <div class="kt-widget__item">
                                <label class="kt-font-dark kt-font-bold">Search Date <span class="kt-font-sm">Sample: 22/09/2020 - 29/10/2020</span></label>
                                <input type="text" class="form-control" id="kt_daterangepicker_my_received_quotations" placeholder="Select date ranges" autocomplete="off">
                            </div>
                        </div>
                        <div class="kt-portlet__head">
                                                                    ...
                                                                    <div class="kt-widget__stats d-flex align-items-center flex-fill">
                                                                        <div class="kt-widget__item">
                                                                            <div class="kt-widget__label">
                                                                                <span class="btn btn-label-dark btn-sm btn-bold btn-upper"><b>Status:</b> <?php echo $qstatus ?></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="kt-widget__item">
                                                                            <div class="kt-widget__label">
                                                                        ...
                                                                        <div class="kt-widget__item">
                                                                            <div class="kt-widget__label">
                                                                                <span class="btn btn-label-dark btn-sm btn-bold btn-upper">
                                                                                    <a href="view/orders/my-quotations-detail.php?quotationId=<?php echo $quotation->qid ?>">Detail Page</a>
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
