...
$res_quotation = $client->request('GET', DIR_CONT . DIR_CAR . 'CON_functions.php?action=get_seller_quotation_by_id&userId='.$userId.'&qid=' . $_GET['quotationId']);
...
//print_r($negotiations);
//echo DIR_CONT . DIR_CAR . 'CON_functions.php?action=get_negotiations_of_quotation&qid=' . $quotation->id;
...
<form method="POST" action="<?php echo DIR_CONT . DIR_CAR . "CON_functions.php?action=change_quotation_status" ?>" id="quotation_status_form">
    <input type="hidden" name="negotiationId" id="negotiationId">
    <input type="hidden" name="status" id="status">
</form>

<form method="POST" action="<?php echo DIR_CONT . DIR_CAR . "CON_functions.php?action=modify_quotation_by_seller" ?>" id="modified_quotation_form">
                                    ...
                                    <div class="kt-widget__top">
                                        ...
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__head">
                                                <a href="<?php echo DIR_VIEW.DIR_PRO;?>productdetails.php?productId=1250" class="kt-widget__title"><?php echo $quotation->name ?></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group" role="group">
                                                        <button class="btn btn-success btn-sm" <?php echo (($negotiation->last_modified_by == 'seller' && $negotiation->nstatus !== 2 || $totalNegotiations >= $i || $negotiation->comment == 'cancelled by the buyer' || $negotiation->comment == 'accepted by the buyer') ? 'disabled' : '') ?> onclick="acceptQuotation(<?php echo $negotiation->nid; ?>)">Accept</button>
                                                        <button type="button" class="btn btn-danger btn-sm" <?php echo (($negotiation->last_modified_by == 'seller' && $negotiation->nstatus !== 2 || $totalNegotiations >= $i || $negotiation->comment == 'cancelled by the buyer' || $negotiation->comment == 'accepted by the buyer') ? 'disabled' : '') ?> onclick="cancelQuotation(<?php echo $negotiation->nid; ?>)">Cancel</button>
                                                        <button class="btn btn-warning btn-block" data-toggle="modal" data-target="#myModal<?php echo $negotiation->nid  ?>" <?php echo (($negotiation->last_modified_by == 'seller' && $negotiation->nstatus !== 2 || $totalNegotiations >= $i || $negotiation->comment == 'cancelled by the buyer' || $negotiation->comment == 'accepted by the buyer') ? 'disabled' : '') ?>>Modify Quotation</button>
                                                    </div>
                                                        ...
                                                        <div class="modal-dialog modal-md">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title">Modify Quotation</h4>
                                                                </div>
