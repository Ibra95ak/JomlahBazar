...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="row">
        <div class="col-md-12">
					 <?php include "https://jomlahbazar.com/api/mashreq/IFRAME_KIT/dataFrom.htm?tp=".$_COOKIE['cookiestp']."&userId=".$_COOKIE['cookiesuserId']."&adid=".$_COOKIE['cookiesaddressId']."&orderId=".$_COOKIE['cookiesorderId']."&orderNumber=".$_COOKIE['cookiesorderNumber'];
					 ?>
        </div>
    </div>
