...
$res_mcat = $client->request('GET', DIR_JSON . 'Read.php?jsonname=maincategories.json');/*fetch all categories*/
...
<head>
	...
	<link href="assets/css/pages/support-center/faq-3.css" rel="stylesheet" type="text/css" />
		...
		fbq('init', '2547761488859495');
		fbq('track', 'PageView');
		</script>
		<noscript><img height="1" width="1" style="display:none"
		src="https://www.facebook.com/tr?id=2547761488859495&ev=PageView&noscript=1"
		/></noscript>
		<!-- End Facebook Pixel Code -->
<!-- Global site tag (gtag.js) - Google Ads: 451853618 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-451853618"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'AW-451853618');
</script>
<!-- Event snippet for Sign-up conversion page -->
<script>
  gtag('event', 'conversion', {​​​​​​​'send_to': 'AW-451853618/6EvVCJj0oPEBELL6utcB'}​​​​​​​);
</script>
[10:59 AM] Adrei
  <!-- Event snippet for Sign-up conversion page linkedin -->
<img height="1" width="1" style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=2768754&conversionId=3965674&fmt=gif" />
					...
					<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
							...
							<ul class="kt-menu__nav ">
								<li class="kt-menu__item  kt-menu__item--submenu header-slot kt-transparent" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><i class="flaticon-placeholder-2 kt-font-dark kt-font-lg"></i><a href="javascript:;" class="kt-menu__link kt-menu__toggle kt-transparent"><img src="assets/media/icons/uae.png" alt="" style="width: 35px;height: 35px;"><i class="fa fa-caret-down dropdown-flag kt-font-dark"></i></a>
						...
						<div class="modal-dialog modal_hamburger" role="document">
							<div class="modal-content">
								<div class="modal-header bg-dark">
									<img src="<?php echo DIR_ROOT.DIR_ICON?>user.png" width="25" height="25" style="margin-right:5px;"/>
							...
							<div class="modal-content">
								...
								<div class="modal-body full-height">
										<h3 class="kt-menu__heading kt-menu__toggle"><span class="kt-menu__link-text kt-font-bolder /*kt-font-light*/">My Account</span></h3>
											...
											<p><a href="<?php echo DIR_VIEW . DIR_USR . "login.php" ?>" class="kt-menu__link "></i><span class="kt-menu__link-text">Qoutations</span></a></p>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-sc-faq-3 kt-sc-feedback">
								...
								<div class="kt-sc__subtitle">
									Your registration to JomlahBazar is completed!
								</div>
								<div class="kt-sc__bg">
									<script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
									<lottie-player src="https://assets7.lottiefiles.com/packages/lf20_qdiq7qa5.json"  background="transparent"  speed="1"  style="height: 500px;"  loop autoplay></lottie-player>
								</div>
							</div>
	<!--End::Dashboard 3-->
</div>
